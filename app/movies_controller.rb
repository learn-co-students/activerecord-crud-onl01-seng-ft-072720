...
def can_be_instantiated_and_then_saved
  movie = Movie.new(title: 'The Matrix',release_date: 1999, director: "The Wachowski Sisters",
  lead: "Keanu Reeves", in_theaters: false)
...
def can_find_using_where_clause_and_be_sorted
  # For this test return all Movie released after 2002 and ordered by 
  # release date descending
  Movie.where(release_date: 2003..2005).order(release_date: :desc)
end
...
def can_update_multiple_items_at_once
  # Change title of all Movie to "A Movie"
  5.times do |i|
